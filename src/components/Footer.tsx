        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              ...
              <li><a href="/sobre-nosotros" className="hover:text-cyan-400 transition-colors">Sobre Nosotros</a></li>
              <li><a href="/blog" className="hover:text-cyan-400 transition-colors">Blog</a></li>
              <li><a href="/privacidad" className="hover:text-cyan-400 transition-colors">Política de Privacidad</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              <li>Lima, Perú</li>
              <li><a href="mailto:connectologyaia@gmail.com" className="hover:text-cyan-400 transition-colors">connectologyaia@gmail.com</a></li>
            </ul>
          </div>
        </div>
